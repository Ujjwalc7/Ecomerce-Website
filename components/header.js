...
const header = (src) => {
    ...
    header.innerHTML = `
        <nav class="navbar navbar-expand-lg ">
            ...
            <div class="collapse form-div navbar-collapse" id="navbarSupportedContent">
                <form role="search">
                    <input class="input-search" id="search" type="search" placeholder="Search..." required />
                    <button class="-btn" type="submit">Go</button>    
                </form>
                <div class="login-div">
                    <button class="Btn"><a href="/pages/login/login.html">login</a></button>
